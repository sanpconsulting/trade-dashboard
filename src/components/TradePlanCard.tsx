...
export function TradePlanCard({ data, capital }: TradePlanCardProps) {
  const { recommendedAction, tradePlan, confidenceScore, recommendedStrategy } = data;
    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-sm flex flex-col h-full overflow-hidden">
      ...
      {isWait ? (
        <div className="flex-1 flex flex-col items-center justify-center p-6 bg-zinc-900/50">
          ...
          <p className="text-zinc-200 font-medium text-sm mb-1">Market Conditions Uncertain</p>
          <p className="text-xs text-zinc-500 text-center max-w-[250px]">Conflicting signals detected. Await clearer structural breaks before entry.</p>
        </div>
      ) : (
        <div className="p-4 flex-1 flex flex-col">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="text-right">
              ...
              <div className="text-[10px] uppercase text-zinc-500">Confidence</div>
            </div>
          </div>

          <div className="flex flex-col gap-2 flex-1">
            <div className="flex justify-between flex-wrap items-end border-b border-zinc-800 pb-2">
              <label className="text-[10px] text-zinc-500 uppercase flex items-center">Entry</label>
            ...
            <div className="flex justify-between flex-wrap items-end border-b border-zinc-800 pb-2">
              <label className="text-[10px] text-zinc-500 uppercase flex items-center">Stop Loss</label>
            ...
            <div className="flex justify-between flex-wrap items-end border-b border-zinc-800 pb-2">
              <label className="text-[10px] text-zinc-500 uppercase flex items-center">Take Profit</label>
            ...
            <div className="flex justify-between flex-wrap items-end border-b border-zinc-800 pb-2 pt-2">
              <label className="text-[10px] text-zinc-500 uppercase">Pos Size</label>
            ...
            <div className="flex justify-between items-end border-b border-zinc-800 pb-2">
              <label className="text-[10px] text-zinc-500 uppercase">R/R</label>
